...
CFG.CAT_KD.LOSS.DE_LOSS_WEIGHT = 1.0
...
CFG.SIMKD = CN()
CFG.SIMKD.FACTOR = 2
CFG.SIMKD.CUTOFF = 0.1
CFG.SIMKD.LOSS = CN()
CFG.SIMKD.LOSS.CE_WEIGHT = 1.0
CFG.SIMKD.LOSS.FEAT_WEIGHT = 1.0

#SFAKD CFG
CFG.SFAKD = CN()
CFG.SFAKD.LOSS = CN()
CFG.SFAKD.LOSS.CE_WEIGHT = 1.0
CFG.SFAKD.LOSS.SFAKD_WEIGHT = 1.0
CFG.SFAKD.CUT_OFF = 0.1
CFG.SFAKD.FREQUENCY_PART = True
CFG.SFAKD.SPATIAL_PART = True